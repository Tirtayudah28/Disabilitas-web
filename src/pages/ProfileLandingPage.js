      ...
      <main id="main-content" className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Tarik perhatian rekruter dengan{" "}
            <span className="text-primary-600">Profil Jobstreet</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Buat profil dan bantu perusahaan mengenal Anda lebih mudah. Dapatkan
            rekomendasi pekerjaan yang sesuai pengalaman dan keahlian Anda.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Bagian Profil Lengkap
              </h3>
              <p className="text-gray-600">
                Tampilkan data diri, pengalaman kerja, pendidikan, dan keahlian
                secara profesional
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Sertakan informasi disabilitas dan kebutuhan aksesibilitas untuk
                mendapatkan akomodasi yang tepat
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Dapatkan rekomendasi lowongan yang sesuai dengan profil dan
                preferensi Anda
              </p>
            </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-primary-500 to-secondary-500 rounded-2xl p-8 text-white max-w-4xl mx-auto">
            ...
            <p className="text-primary-100 mb-6 text-lg">
              Mulai bangun profil profesional Anda sekarang dan buka peluang
