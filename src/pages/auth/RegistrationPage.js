    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 flex items-center justify-center py-8 px-4">
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 space-y-6">
          ...
          {!showEmailForm ? (
            ...
            <form onSubmit={handleEmailRegister} className="space-y-4">
              <p>Section 1 account info</p>
              {/*fatir: input text username (alphanumeric)*/}
              <div>
                <label
                  htmlFor="username"
        ...
        <div className="sr-only" aria-live="polite" aria-atomic="true">
          Halaman registrasi untuk platform InklusiKerja. Daftar dengan Google
          atau email untuk pencari kerja disabilitas.
        </div>
      </div>
    </div>
  );
