...
const AddUserExpPopup = ({ isVisible, onClose, onCreate }) => {
  ...
  const handleCreate = () => {
    if (
      ...
      return enqueueSnackbar("Field yang dibutuhkan masih belum lengkap", {variant: "warning"});
    }
    ...
    >
      ...
      >
        ...
        <div className="flex justify-between px-4 py-3 border-b border-gray-300 bg-gray-50">
          <h1 className="font-semibold text-lg">Tambah Pengalaman</h1>
        ...
        <div className="px-7 py-5 space-y-6 overflow-y-auto max-h-[60vh]">
          ...
          <div className="relative">
            <label className="text-sm text-gray-800">Perusahaan</label>
            <input
              type="text"
              name="companyName"
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 mt-1">
              Kosongkan jika ini adalah pengalaman anda sekarang.
            </p>
          </div>
...
export default AddUserExpPopup;
